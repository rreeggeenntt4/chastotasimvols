<?php
/**
 * Эта функция имеет линейную сложность, так как она проходит по строке один раз для подсчета количества встреч каждого символа
 * и затем выполняет сортировку массива символов. 
 */
